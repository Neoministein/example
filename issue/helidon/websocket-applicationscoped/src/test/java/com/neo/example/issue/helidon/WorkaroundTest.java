...
import com.neo.example.issue.helidon.workarround.WebsocketEndpointWorkaround;
...
class WorkaroundTest {
    ...
    @Inject
    protected WebsocketEndpointWorkaround websocketEndpoint;
    ...
    void test() throws Exception {
        Session session_1 = connectToWebsocket("websocket/workaround/id-1");
        session_1.getBasicRemote().sendText("A message 1");

        Session session_2 = connectToWebsocket("websocket/workaround/id-2");
